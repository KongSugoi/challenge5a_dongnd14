...
$sql ="SELECT ID FROM tbluser WHERE ID=:sid and Password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update tbluser set Password=:newpassword where ID=:sid";
...
echo '<script>alert("Mật khẩu hiện tại của bạn đang sai")</script>';
...
<html lang="en">
  <head>
    ...
    <title>Hệ thống quản lý sinh viên|| Đổi mật khẩu</title>
    <!-- plugins:css -->
...
{
alert('Mật khẩu xác nhận đang không trùng khớp');
